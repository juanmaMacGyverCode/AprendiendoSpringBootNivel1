...
Un simple proyecto en el cual hago una web haciendo uso de Spring Boot. Consta de dos páginas web, una donde se muestra la información del local y otra web donde se muestra la carta del restaurante.
Puede ser el proyecto como una forma de prácticar para aprender Spring Boot. Aqui hago un uso muy básico del controlador para mapear plantillas HTML. No tiene complicaciones.
...
_Por ahora no tiene pruebas, pero os animo a que colaboreis conmigo_
...
_Todos aquellos que su contribución hara sino unida a mi proyecto serán mencionados:_
